...
> GRADE 12/10: Great work, and nice job completing the environments section. Note that you'd want to push repo .Rmd with any dependencies like the manually uploaded `deck.csv`.
...
# c) Simulate the process 1000 times
# Exponential distribution with rate = 0.5 (mean = 2 inches)
snow_sim <- rexp(1000, rate = 0.5)

# d & e) Put into a tibble
snow_df <- tibble(snowfall = snow_sim)
...
snow_df %>%
  ...
  labs(
    title = "Simulated Daily Snowfall Amounts",
    x = "Snowfall (inches)",
    y = "Frequency"
  ) +
  theme_minimal()
